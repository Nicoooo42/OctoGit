...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col border-r border-slate-800 bg-slate-800/60 text-sm">
      ...
      <SectionHeader title="État des fichiers" />
      <div className="px-4 pb-4">
        <div className="flex items-center justify-between mb-2">
          <div className="text-xs font-medium text-slate-400">Fichiers</div>
          <button
            type="button"
            onClick={refreshStatus}
            className="flex h-5 w-5 items-center justify-center rounded border border-slate-700/60 bg-slate-900/60 text-slate-400 transition hover:border-cyan-400/40 hover:text-cyan-200"
            title="Actualiser"
          >
